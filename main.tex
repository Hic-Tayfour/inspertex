...
\usepackage{
    fontspec
} % uso de fontes TrueType (requer motor de compilação XeLaTeX ou LuaLaTeX)
...
\usepackage{physics} % aliases notação matemática simplificada
...
% Fontes bibliográficas (permitido utilizar múltiplas fontes)
\addbibresource{referencias.bib}
%\addbibresource{outras-referencias.bib}
...
% Palavras-chaves (importante: separar com vírgulas)
\palavraschaves{abnt, LaTeX, formatação, equações, microeconomia}
% Palavras-chaves em inglês (importante: separar com vírgulas)
\keywords{abnt, LaTeX, formatting, equations, microeconomics}
% Professores convidados (importante: separar com vírgulas)
